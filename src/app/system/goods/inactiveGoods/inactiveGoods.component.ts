...
@Component({
    selector: 'app-view-detail-goods-inactive',
    templateUrl: './inactiveGoods.component.html',
    styleUrls: ['./inactiveGoods.component.css']
})

/**
 * 商品发布组件
 */
export class InactiveGoodsComponent implements OnInit {
    title = '商品下架';
    ...
    private initSingleGoods() {
        ...
        this.ftConfitService.manageGoodsConfig(formData).subscribe(res => {
            const data = this.commonService.filterResult(res);
