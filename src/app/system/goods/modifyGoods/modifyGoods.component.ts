...
export class ModifyGoodsComponent implements OnInit {
    ...
    constructor(private ftConfitService: FatigeConfigService, private datePipe: DatePipe, private commonService: CommonServie,
                public pxGoodsOrderTypeEnum: PxGoodsOrderTypeEnum, public pxGoodsHuiyuanEnum: PxGoodsHuiyuanEnum, public pxGoodsQuanEnum:PxGoodsQuanEnum,
                public pxGoodsTuanEnum:PxGoodsTuanEnum, public pxGoodsTypeEnum:PxGoodsTypeEnum,
