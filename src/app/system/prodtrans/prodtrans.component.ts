...
@Component({
    selector: 'app-system-prodtrans',
    templateUrl: './prodtrans.component.html',
    styleUrls: ['./prodtrans.component.css']
})

/**
 * 店铺会员产品账管理组件
 */
export class ProdtransComponent implements OnInit {
    title = '店铺会员产品账管理!';
    contactKey: string;
     ...
     */
    constructor(private ftConfitService: FatigeConfigService, private datePipe: DatePipe, private pxShopStatusEnum: PxShopStatusEnum,
    ...
    initShopList() {
        this.tableElement = {
            'tableHeaders': [],
            'tableOp': [['店铺会员产品账管理', 'system_prodtrans_usr_shop_prod']],
            'tableContent': []
        };
